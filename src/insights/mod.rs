...
const NO_REPO_HOST_MERGE_DATA: &str = "requires a merged-MR/PR listing from the code host; RepoHost currently only \
...
const NO_VALIDATION_DATA: &str = "requires production validation verdicts (AIR-10) or a linked incident ticket, neither tracked yet";
    ...
    fn successful_parallel_cycles_counts_overlapping_successful_dispatches() {
        ...
        seed(
            ...
            &[
                ...
                ("2", "dispatched", None, None, "2026-01-01T00:00:30Z"),
                (
                    "1",
                    "worker_exit",
